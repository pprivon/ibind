...
IBIND_OAUTH2_TOKEN_URL = os.getenv('IBIND_OAUTH2_TOKEN_URL', None)
""" OAuth 2.0 Token Endpoint URL. Defaults to 'https://api.ibkr.com/oauth2/api/v1/token' in OAuth2Config. """

IBIND_OAUTH2_SSO_SESSION_URL = os.getenv('IBIND_OAUTH2_SSO_SESSION_URL', None)
""" OAuth 2.0 SSO Session Endpoint URL. Defaults to 'https://api.ibkr.com/gw/api/v1/sso-sessions' in OAuth2Config. """

IBIND_OAUTH2_AUDIENCE = os.getenv('IBIND_OAUTH2_AUDIENCE', None)
""" OAuth 2.0 Audience for the JWT. Defaults to '/token' in OAuth2Config. """

IBIND_OAUTH2_SCOPE = os.getenv('IBIND_OAUTH2_SCOPE', None)
""" OAuth 2.0 Scope. Defaults to 'sso-sessions.write' in OAuth2Config. """
...
""" OAuth 2.0 Private Key PEM content. Newlines may be escaped as '\\n' since environment variables cannot hold literal newlines. """
